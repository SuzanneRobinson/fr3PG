...
# get measured values
##################################
dbh_average<-read.csv(paste0(path2files,"double_bark_thickness/DBT_Poplar_Tadcaster_annual_average.csv"))
...
for (i in c(1:15)){
  ...
  if(file.exists(paste0("C:/Users/suzanne.robinson/OneDrive - Forest Research/projects/3PG_SonWaL/productive_broadleaf_development/dendro/calibration/poplar_tadcaster_",timeStep,"_",chainNum,".RDS"))==TRUE){
    print("previous file exists, restarting chain")
    out<-readRDS(paste0("C:/Users/suzanne.robinson/OneDrive - Forest Research/projects/3PG_SonWaL/productive_broadleaf_development/dendro/calibration/poplar_tadcaster_",timeStep,"_",chainNum,".RDS"))
  }
  ...
  out<-suppressWarnings(if(file.exists(paste0("C:/Users/suzanne.robinson/OneDrive - Forest Research/projects/3PG_SonWaL/productive_broadleaf_development/dendro/calibration/poplar_tadcaster_",timeStep,"_",chainNum,".RDS"))==TRUE) runMCMC(bayesianSetup =out, sampler = "DEzs", settings = settings) else runMCMC(bayesianSetup =BS3PGDN, sampler = "DEzs", settings = settings))
  
  summary(out)
  
  #Save output
  saveRDS(out,file=paste0("C:/Users/suzanne.robinson/OneDrive - Forest Research/projects/3PG_SonWaL/productive_broadleaf_development/dendro/calibration/poplar_tadcaster_",timeStep,"_",chainNum,".RDS"))
...
exampParams<-readRDS("C:/Users/suzanne.robinson/OneDrive - Forest Research/projects/3PG_SonWaL/productive_broadleaf_development/dendro/calibration/poplar_tadcaster_monthly_1.RDS")
...
ggplot() +
  ...
  geom_point(data=dbh_average, aes(x=YEAR, y= DBH.Average.across.years..2005.2022, color=' DBH.Average.across.years..2005.2022'), size=2) +
  scale_color_manual(name = "Data", 
                     ...
                     labels = c('Line' = '3PG',
                                'D.ob..cm.' = 'D.ob..cm.', 
                                'D.ub..cm.' = 'D.ub..cm.', 
                                ' DBH.Avarage.across.years..2005.2022' = ' DBH.Average.across.years..2005.2022')) +
  labs(x = "Year",
       y = "Mean stand DBH [cm]") +
  theme_classic()
